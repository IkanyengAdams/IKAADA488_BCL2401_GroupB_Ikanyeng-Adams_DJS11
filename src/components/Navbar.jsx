    ...
    return (
        <>
            ...
            <div className='flex items-center gap-2 mt-4'>
                <button className='bg-white text-black px-4 py-1 rounded-2xl' onClick={() => onSort('asc')}>Sort A-Z</button>
                <button className='bg-white text-black px-4 py-1 rounded-2xl' onClick={() => onSort('desc')}>Sort Z-A</button>
            </div>
        </>
    );
}
